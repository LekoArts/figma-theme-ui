...
var ui = (function () {
    ...
    function add_css$5() {
    	...
    	style.textContent = ".wrapper.svelte-v31qci{text-align:center}.footer.svelte-v31qci{padding-top:var(--size-xxsmall);border-top:1px solid var(--hover-fill)}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$5, 49, 6, 1067);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t0, anchor);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "rel", "noreferrer noopener");
    			add_location(a, file$5, 57, 6, 1238);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 46, 2, 980);
    			attr_dev(div1, "class", "wrapper p-xsmall svelte-v31qci");
    			add_location(div1, file$5, 43, 0, 865);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
