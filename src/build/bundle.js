...
var ui = (function () {
    ...
    /* node_modules/figma-plugin-ds-svelte/src/components/Checkbox/index.svelte generated by Svelte v3.16.7 */
    ...
    function add_css$4() {
    	...
    	style.textContent = ".wrapper-styles.svelte-rvpxj{justify-content:center}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }

    // (22:2) <Checkbox bind:checked={colorsChecked} {disabled}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(22:2) <Checkbox bind:checked={colorsChecked} {disabled}>",
    		ctx
    	});
    ...
    // (23:2) <Checkbox bind:checked={typographyChecked} {disabled}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:2) <Checkbox bind:checked={typographyChecked} {disabled}>",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:2) <Button on:click {disabled}>",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	function checkbox1_checked_binding(value_1) {
    		/*checkbox1_checked_binding*/ ctx[4].call(null, value_1);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 20, 0, 298);
    			attr_dev(div1, "class", "mt-xsmall flex wrapper-styles svelte-rvpxj");
    			add_location(div1, file$4, 24, 0, 487);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$6, 55, 6, 1207);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t0, anchor);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "rel", "noreferrer noopener");
    			add_location(a, file$6, 63, 6, 1378);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	addstyles.$on("click", /*createStyles*/ ctx[4]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 52, 2, 1120);
